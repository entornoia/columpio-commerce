...
export const commerceToolDefinitions = [
  ...
  { type: "function" as const, name: "create_payment_link", description: "Crea o recupera el link Flow del pedido pendiente más reciente. payerEmail debe ser el correo entregado literalmente por la clienta o null; nunca inventarlo. No recibe importes, URLs ni identificadores.", strict: true, parameters: { type: "object", additionalProperties: false, properties: { payerEmail: { type: ["string", "null"] } }, required: ["payerEmail"] } },
] as const;
