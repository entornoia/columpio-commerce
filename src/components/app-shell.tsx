...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  const links = [{ href: "/admin", label: "Inicio", icon: "home" as const }, { href: "/pedidos", label: "Pedidos", icon: "layers" as const }, { href: "/productos", label: "Productos", icon: "box" as const }, { href: "/catalog-search", label: "Buscar catálogo", icon: "search" as const }, { href: "/agent-test", label: "Agente vendedor", icon: "layers" as const }, { href: "/instagram-conversations", label: "Instagram", icon: "layers" as const }, { href: "/productos/nuevo", label: "Agregar producto", icon: "plus" as const }];
